...
public class ChangedPackagesAsyncTask extends AsyncTask<Void, Void, Void> {
    ...
    public ChangedPackagesAsyncTask(Context context, ChangedPackages changedPackages) {
        this.mContext = context;
        this.mChangedPackageNames = changedPackages.getPackageNames();
    }
        ...
        for (ResolveInfo info : resolveInfoList) {
            ...
            while (homeIterator.hasNext()) {
                ...
                if (homeInfo.activityInfo.name.equals(info.activityInfo.name)
                        || mContext.getPackageName().equals(info.activityInfo.packageName)
